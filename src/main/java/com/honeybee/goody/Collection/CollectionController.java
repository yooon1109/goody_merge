...
public class CollectionController {
    ...
    @GetMapping("/detail")
    public Map<String, Object> getCollectionDetail(@Parameter(description = "유저 아이디") @RequestParam String userId, @Parameter(description = "컬렉션 번호") @RequestParam String collectionId) throws Exception {
    ...
    @GetMapping("/list")
    public Map<String, Object> getCollectionList(@Parameter(description = "유저 아이디") @RequestParam String userId) throws Exception {
